...
namespace Subdivisions.Aws.Tests.Specs.Integration.Clients;
...
public class AwsEventsTests : LocalstackFixture
{
    ...
    public async Task ShouldPushEvent()
    {
        ...
        var result = await sut.Produce(topic, message, null, false, default);
        ...
        messageFromQueue.Value<string>("payload")!.AsJToken()
